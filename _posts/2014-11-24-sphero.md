...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/sphero.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/start-to-play.jpg){: .align-center}

The Sphero application will search for a connected Sphero device

![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/connected.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/main-control-screen.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/sphero-sprk.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/tickle-splash.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/tickle-automation.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/tickle-block-programming.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/tynker-splash.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/tynker-play-or-create.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/tynker-create.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/tynker-default-actor.jpg){: .align-center}

Most actors are cartoon characters, if you want robots then they are called connected devices.

![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/tynker-select-theme.jpg){: .align-center}

The list of devices you can use with Tynker isn’t as comprehensive as Tickle but it does contain Sphero and Ollie!

![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/tynker-list-of-devices.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/tynker-sphero-actor.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/tynker-block-programming.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/macrolab-macros.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/macrolab-commands.jpg){: .align-center}

## SPRK (Schools, Parents, Robots, Kids)

![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/sphero-sprk-block-splash.jpg){: .align-center}

Another application from Orbotix, this one closer resembles other visual block programming languages.

![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/sphero-sprk-block-programming.jpg){: .align-center}

The advantage to using the application is that all of the blocks are dedicated to controlling the Sphero device.

![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/sphero-sprk-block-programming-control.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/orbbasic.jpg){: .align-center}

Luckily this application comes with a comprehensive help screen

![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/orbbasic-help.jpg){: .align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/posts/2014-11-24-sphero/orbbasic-code-console.jpg){: .align-center}
